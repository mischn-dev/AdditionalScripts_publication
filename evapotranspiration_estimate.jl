...
# klein altendorf
we1 = CSV.read("Klein_Altendorf_2011-2019.csv")
we1 = unique(we1)
...
# dikopshof
ew = CSV.read("evapotranspiration_calc.csv", missingstring="NA")
ew = unique(ew)
...
sh = CSV.read("gerste_saat_ernte.csv", delim=";")
...
draw(PNG("ETs1996_2019_2col180nFK32.png",18inch, 15inch, dpi=600),pp3)
...
CSV.write("Kon_Evapotranspiration96-19_180nFk.csv", env[:kon][:all])
CSV.write("Org_Evapotranspiration96-19_180nFk.csv", env[:org][:all])
